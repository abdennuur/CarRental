...
<head>
	...
	<title>CarBNB | Admin Update Image 2</title>
...
<div class="col-sm-8">
<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="1024" height="1024" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
